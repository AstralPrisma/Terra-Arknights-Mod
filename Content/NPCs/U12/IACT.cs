...
using Arknights.Content.BossBars;
using System.Threading;

namespace Arknights.Content.NPCs.U12
{
	[AutoloadBossHead]
	public class IACT : ModNPC
	{
		private const string ChainTextPath= "Arknights/Content/Content/NPCs/U12/IACT";
		...
		public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)//贴图，位置，大小区域，光亮颜色，转动角度，中心点坐标，缩放倍率，特殊效果(翻转)，图层
		{
			...
			{
				Texture2D maskTexture = ModContent.Request<Texture2D>("Arknights/Content/NPCs/U12/IACTMask").Value;//常驻高亮部分
			...
			if(stage == 1 || stage == 1.5f)//一阶段+一转二阶段
            {
				...
				Texture2D OutringTexture = ModContent.Request<Texture2D>("Arknights/Content/NPCs/U12/OAO").Value;
				Texture2D InringTexture = ModContent.Request<Texture2D>("Arknights/Content/NPCs/U12/IAOR").Value;
				Texture2D waveTexture = ModContent.Request<Texture2D>("Arknights/Content/NPCs/U12/IACTLightwave").Value;
			...
			else if(stage == 2 || stage == 2.5f)//二阶段+二转三阶段
            {
				...
				Texture2D OutringTexture2 = ModContent.Request<Texture2D>("Arknights/Content/NPCs/U12/OAF").Value;
				Texture2D InringTexture2 = ModContent.Request<Texture2D>("Arknights/Content/NPCs/U12/IAFR").Value;
				Texture2D waveTexture = ModContent.Request<Texture2D>("Arknights/Content/NPCs/U12/IACTLightwave").Value;
			...
			else if(stage >= 3)//三阶段
            {
				...
				Texture2D OutringTexture3 = ModContent.Request<Texture2D>("Arknights/Content/NPCs/U12/OARS").Value;
				Texture2D OutringTexture4 = ModContent.Request<Texture2D>("Arknights/Content/NPCs/U12/OAR").Value;
				Texture2D InringTexture3 = ModContent.Request<Texture2D>("Arknights/Content/NPCs/U12/IARS").Value;
				Texture2D InringTexture4 = ModContent.Request<Texture2D>("Arknights/Content/NPCs/U12/IAR").Value;
				Texture2D waveTexture = ModContent.Request<Texture2D>("Arknights/Content/NPCs/U12/IACTLightwave").Value;
        ...
        public override void AI()
		{
			...
			if(NPC.life > 1 && NPC.dontTakeDamage != true)//一二阶段和三阶段的部分移动
			{
				...
				{
					timer2 = 0;
					SoundEngine.PlaySound(new SoundStyle("Arknights/Content/Sounds/AlertPro") with { Volume = 1f, Pitch = 0f }, NPC.Center);
			...
			if(truestage1to2 == 1)//一二阶段转阶段锁血以及攻击
			{
			 	...
			 	if(timer1to2 <= stage1to2locktime)
				{
					...
					else if(timer1to2 >= 120 && timer1to2 < 180)
					{
						...
						{
							SoundEngine.PlaySound(new SoundStyle("Arknights/Content/Sounds/IACTStageChangeTip") with { Volume = 1f, Pitch = 0f }, Player.Center);
						}
					...
					else if(timer1to2 >= 300)
					{
						...
						{
							SoundEngine.PlaySound(new SoundStyle("Arknights/Content/Sounds/iactstage1to2") with { Volume = 1f, Pitch = 0f }, Player.Center);
						}
			...
			if(truestage2to3 == 1)
			{
			 	...
			 	if(timer2to3 <= stage2to3locktime)
				{
					...
					else if(timer2to3 >= 240 && timer2to3 < 360)
					{
						...
						{
							SoundEngine.PlaySound(new SoundStyle("Arknights/Content/Sounds/IACTStageChangeTremor") with { Volume = 1f, Pitch = 0f }, Player.Center);
						}
	...
	{
		private const string ChainTextPath="Arknights/Content/NPCs/U12/Deathdust";
		public override void SetStaticDefaults()
		{
		}
		public override void SetDefaults()
	...
	{
        private const string ChainTextPath = "Arknights/Content/NPCs/U12/IACTStage3target";
        public override void SetStaticDefaults()
        {
            Main.npcFrameCount[NPC.type] = 1;//贴图帧数
        }
	...
	{
		private const string ChainTextPath = "Arknights/Content/NPCs/U12/ISTG3InCore";
		public override void SetStaticDefaults()
		{
		}
    ...
    {
        private const string ChainTextPath = "Arknights/Content/NPCs/U12/ISTG3InRing";
        public override void SetStaticDefaults()
        {
        }
    ...
    {
        private const string ChainTextPath = "Arknights/Content/NPCs/U12/ISTG3OutRing";
        public override void SetStaticDefaults()
        {
        }
    ...
    {
        private const string ChainTextPath = "Arknights/Content/NPCs/U12/ISTG3OutPrism";
        public override void SetStaticDefaults()
        {
        }
	...
	{
		private const string ChainTextPath="Arknights/Content/NPCs/U12/AuragreenPro";
		public override void SetStaticDefaults()
		{
		}
		public override void SetDefaults()
	...
	{
		private const string ChainTextPath="Arknights/Content/NPCs/U12/AuraredPro";
		public override void SetStaticDefaults()
		{
		}
		public override void SetDefaults()
	...
	{
		private const string ChainTextPath="Arknights/Content/NPCs/U12/Hitboxgreen";
		public override void SetStaticDefaults()
		{
		}
		public override void SetDefaults()
		...
		public override void Kill(int timeLeft)//下一阶段：召唤普通橘色判定箱和普通绿色伤害箱
		{
			...
			SoundEngine.PlaySound(new SoundStyle("Arknights/Content/Sounds/Alert") with { Volume = 1f, Pitch = 0f }, Projectile.Center);
	...
	{
		private const string ChainTextPath="Arknights/Content/NPCs/U12/Hitboxorange";
		public override void SetStaticDefaults()
		{
		}
		public override void SetDefaults()
	...
	{
		private const string ChainTextPath="Arknights/Content/NPCs/U12/Hitboxred";
		public override void SetStaticDefaults()
		{
		}
		public override void SetDefaults()
		...
		{
			var newSource = Projectile.GetSource_FromThis();
            SoundEngine.PlaySound(new SoundStyle("Arknights/Content/Sounds/Explode") with { Volume = 1f, Pitch = 0f }, Projectile.Center);
	...
	{
		private const string ChainTextPath="Arknights/Content/NPCs/U12/HitboxredPro";
		public override void SetStaticDefaults()
		{
		}
		public override void SetDefaults()
	...
	{
		private const string ChainTextPath="Arknights/Content/NPCs/U12/Hitblockgreen";
		public override void SetStaticDefaults()
		{
		}
		public override void SetDefaults()
	...
	{
		private const string ChainTextPath="Arknights/Content/NPCs/U12/Hitblockorange";
		public override void SetStaticDefaults()
		{
		}
		public override void SetDefaults()
	...
	{
		private const string ChainTextPath="Arknights/Content/NPCs/U12/HitboxblueCore";
		public override void SetStaticDefaults()
		{
		}
		public override void SetDefaults()
	...
	{
		private const string ChainTextPath="Arknights/Content/NPCs/U12/HitboxblueFrame";
		public override void SetStaticDefaults()
		{
		}
		public override void SetDefaults()
	...
	{
		private const string ChainTextPath="Arknights/Content/NPCs/U12/null";
		public override void SetStaticDefaults()
		{
		}
		public override void SetDefaults()
    ...
    {
        private const string ChainTextPath = "Arknights/Content/NPCs/U12/missle";
        public override void SetStaticDefaults()
        {
        }
        public override void SetDefaults()
